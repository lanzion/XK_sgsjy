<template>
    <div class="fb-statistics">
        ...
        <div class="table-layout">
            ...
            <v-pie-chart :datas="courseTypeDatas" title="课程分布" centerTitle="活动(个)" class="backend-content__module echart"></v-pie-chart>
            </div>
            <div class="small-module table-cell echart">
...
<script>
    ...
    import barChart from 'Common/statis/bar_chart.vue'
    import pieSimpleChart from 'Common/statis/pie-simple_chart.vue'
    import pieDoughnutChart from 'Common/statis/pie-doughnut_chart.vue'
        ...
        methods: {
            getData() {
                ...
                requesAreaSchoolSpace(this.params).then((response) => {
                    if (response.data.code === 200) {
                        const _data = response.data.appendInfo.item || {}
                        const _result = {
