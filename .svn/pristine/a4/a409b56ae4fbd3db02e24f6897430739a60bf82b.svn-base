<template>
    <div class="statistics">
        ...
        <div class="class-statis-detail">
            ...
            <v-pagination class="class-pagination" :param.sync="page" :changePage="changePage"></v-pagination>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 统计详情
            getDetailData({order = {}} = {order}) {
                let param = Object.assign(order, {id: this.id}, this.pageParam)
            ...
            sortChange({column, prop, order} = {column, prop, order}) {
                let param = {}
                if (column) {
                    param = {
