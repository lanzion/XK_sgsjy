<template>
    <section id="subjectDetailDiscussInitiate">
        ...
        <div class="discussinitiate-form-select">
            ...
            <i v-if="title.length > 30" class="el-icon-circle-cross" style="color:#DD0000;"> 超过30个字符</i>
            ...
            <i v-if="content.length > 250" class="el-icon-circle-cross" style="color:#DD0000;"> 超过200个字符</i>
