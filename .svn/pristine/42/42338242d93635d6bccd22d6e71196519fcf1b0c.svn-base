<template>
  	<div id="activityDetails" class="container detail-content clearfix">
        ...
        <el-breadcrumb separator=">" class="navigation">
            <el-breadcrumb-item :to="{ path: '/street/activity' }">首页</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/street/activity/list' }">活动列表</el-breadcrumb-item>
		...
		<div class="content-left fl">
			<div class="banner-box clearfix">
				<div class="img-box fl">
					<img title="点击查看原图" @click="visible.show = true" :src="getFileUrl(activityDetails.cover)" height="180" width="280">
				</div>
