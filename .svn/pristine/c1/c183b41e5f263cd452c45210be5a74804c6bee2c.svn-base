...
<script>
  import releaseAdd from '@/components/admin/backstage/course/course_release_add.vue'
  import releaseInfo from '@/components/admin/backstage/course/course_release_info.vue'
