<template>
	<div class="subject_unchecked_list">
...
<script>
	...
	import subjectItem from 'Common/module/subject/subject_item_msg.vue';
	import { requestBackendSubjectList } from '@/service/subject.js';
	import { loginInfo,baseInfo } from '@/js/getUserInfo.js'
	export default {
		name:'subject_unchecked_list',
		components:{
