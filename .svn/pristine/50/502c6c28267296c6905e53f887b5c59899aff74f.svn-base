<template>
  <div>
    <el-popover
      ...
      :width="popperWidth>400?popperWidth:400"
      trigger="click"
    >
      ...
      <ul class="select-popover-itemList">
        <li
          ...
          v-if="schoolForm.schoolName=='' || item.schoolName.includes(schoolForm.schoolName.trim())"
    ...
    <el-select
      ...
      v-model="checkedItem"
      placeholder="请选择所在区域所在学校"
      popper-class="select-isPopover"
      style="width:100%"
      :disabled="disabled"
    >
      <el-option
