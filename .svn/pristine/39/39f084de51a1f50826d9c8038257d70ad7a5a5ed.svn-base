<template>
    <div class="lagouDetail container clearfix">
        ...
        <el-breadcrumb separator=">" class="navigation">
            ...
            <el-breadcrumb-item @click.native="redirect(pages.list[module].url)">{{moduleName}}列表</el-breadcrumb-item>
            <el-breadcrumb-item>{{moduleName}}详情</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <div class="content_r fr">
            ...
            <section class="correlation">
                <h3 class="correlation_title">相关{{moduleName}} <a @click="redirect(pages.list[this.module], { type: 2 })" class="correlation_title_more fr">更多>></a></h3>
...
export default {
    ...
    methods: {
        ...
        analysisPath() {
            ...
            if (type === '1') {
                this.items = [
                    { path: '/street', title: '活动街区' },
                    { path: '/street/lagou/1', title: '所有服务' },
                    { path: '', title: '服务详情' }
                ]
            } else if (type === '2') {
                this.items = [
                    { path: '/street', title: '活动街区' },
                    { path: '/street/lagou/2', title: '所有需求' },
                    { path: '', title: '需求详情' }
                ]
            }
        },
...
@import '~@/assets/css/scss/aboutList.scss';
$blue: #0694e8;
$p15: 15px;
.content_l {
    width: 906px;
