  ...
  <el-dialog :visible.sync="dialog.isVisible" title="发私信" class="send-private-letter">
    <section class="form-box">
      ...
      <div class="button-group">
        <button class="i-form-button is-plain" @click="dialog.isVisible = false">取消</button>
        <button class="i-form-button" @click="send">确定</button>
      </div>
    </section>
  </el-dialog>
</template>
...
<script>
  ...
  export default {
    name: 'sendPrivateLetter', // 教师学生空间，发私信
    props: ['dialog'],
    data () {
      return {
        content: '',
