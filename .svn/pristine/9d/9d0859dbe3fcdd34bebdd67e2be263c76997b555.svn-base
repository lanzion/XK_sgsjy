  ...
  <div class="backend-course__question">
    <div class="options">
      ...
      <a @click="showDialog('managePoint')" href="javascript:;" class="btn-manage btn" title="管理知识点"><i
        class="icon-btn-add icon"></i>添加知识点</a>
    </div>
...
<script>
  ...
  import addQuestion from '@/components/course/add_question_dialog.vue'
  import managePoint from '@/components/course/manage_point_dialog.vue'
