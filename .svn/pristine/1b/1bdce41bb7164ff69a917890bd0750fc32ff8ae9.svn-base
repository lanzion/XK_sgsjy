        ...
        <el-form ref="form" :model="form" label-width="100px" :rules="rules">
            ...
            <el-row>
                <el-form-item label="学校名称" prop="schoolName">
                    <el-col :span="8">
                        <el-input v-model="form.schoolName" placeholder="请输入学校名称" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 密码名称 -->
                ...
                <el-form-item label="学段" prop="schoolType">
                    <el-col :span="8">
                        <el-checkbox-group v-model="form.schoolType">
                            <el-checkbox v-for="item in learningStages" :label="item.id" :key="item.id" :disabled="schoolTypeDisabled">{{item.name}}</el-checkbox>
                        </el-checkbox-group>
                    </el-col>
                </el-form-item>
            </el-row>
            ...
            <el-row v-if="identity=='education' || identity=='admin'">
                <el-form-item label="所属区域" prop="region">
                    <el-col :span="8">
                        <v-region-select :defaultItems="region" class="select-region" @region="changeRegion" :isAdmin="true" :disabled="isReadOnly"></v-region-select>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 主管部门 -->
            <el-row v-if="identity=='education' || identity=='admin'">
                <el-form-item label="主管部门" prop="departmentId">
                    <el-col :span="8">
                        <el-select v-model="form.departmentId" placeholder="请选择主管部门" :disabled="isReadOnly">
            ...
            <el-row>
                <el-form-item label="联系人" prop="linkName">
                    <el-col :span="8">
                        <el-input v-model="form.linkName" placeholder="请输入联系人" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 联系电话 -->
            ...
            <el-row>
                <el-form-item label="传真" prop="fax">
                    <el-col :span="8">
                        <el-input v-model="form.fax" placeholder="请输入传真" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 电子邮箱 -->
            ...
            <el-row>
                <el-form-item label="地址" prop="address">
                    <el-col :span="8">
                        <el-input v-model="form.address" placeholder="请输入地址" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 学校简介 -->
            <el-row>
                <el-form-item label="学校简介" prop="remark">
                    <el-col :span="10">
                        <el-input type="textarea" v-model="form.remark" placeholder="请输入学校简介" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
...
export default {
    ...
    computed: {
        ...
        schoolTypeDisabled: function() {
            return this.isReadOnly || this.identity === 'school'
        }
    },
    methods: {
        ...mapActions({
