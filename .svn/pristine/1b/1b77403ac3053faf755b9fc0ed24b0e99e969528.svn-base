    ...
    <section id="courseDetailDiscussInitiate" class="dpd15">
        <div class="title">
            <div class="title_l fl">
                ...
                >
                <router-link :to="{ path: 'discussTheme', query: $route.query}" v-if='this.$route.query.discussType'>{{title}} ></router-link>
                <span>发起新主题</span>
            </div>
        ...
        <div class="discussinitiate-form-select">
            <template v-if="this.$route.query.discussType === undefined">
                ...
                <div class="select_box">
                    ...
                    <i v-if="select.value !== ''" class="el-icon-circle-check" style="color:#23b8ff;"></i>
                </div>
            </template>
            ...
            <i v-else-if="select.input !== ''" class="el-icon-circle-check" style="color:#23b8ff;"></i>
            ...
            <i v-if="select.content.length > 1000" class="el-icon-circle-cross" style="color:#DD0000;"> 超过1000个字符</i>
            <i v-else-if="select.content !== ''" class="el-icon-circle-check" style="display: block;margin-top: 6px;color:#23b8ff;"></i>
            <div class="select_box">
                ...
                <i v-if="select.sectionId !== ''" class="el-icon-circle-check" style="color:#23b8ff;"></i>
            </div>
