	...
	<!-- 活动描述 -->
		<div class="activity-img backend-content__middle clearfix" v-if="isAudited">
			<div class="img-box fl">
				<img title="点击查看原图" @click="visible.show = true" :src="getFileUrl(detailsData.cover)" height="190" width="193">
			</div>
...
<script>
	...
	import activityDetail from '@/components/space/activity/activity_mng_detail.vue'
