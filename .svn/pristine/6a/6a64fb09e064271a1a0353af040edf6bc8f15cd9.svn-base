<template>
    <div id="clasz_manage" class="container" :class="{'is-admin': isAdmin}">
        ...
        <el-breadcrumb separator=">" style="padding: 1em 0;">
            <el-breadcrumb-item :to="{ path: pages.detail.clasz.path, query:{ id: $route.query.id } }">班级空间</el-breadcrumb-item>
    ...
    data() {
        return {
            navItem: [
                ...
                { url: 'memberManage', name: '成员管理' },
                { url: 'claszNoticeManage', name: '公告管理' }
            ]
        }
    },
    created() {
