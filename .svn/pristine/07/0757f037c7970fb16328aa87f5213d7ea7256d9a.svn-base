                ...
                <li v-for="(item,index) in interestData" class="clearfix">
                    ...
                    <div class="msg-box verticle-middle">
                        <div class="interest-name clearfix">
                            <a @click="redirect(pages.detail.interest, { query: { id: item.id } })" v-if="item.auditStatus == 1" class="name fl red">
                                {{item.name}}
                            </a>
                            <router-link :to="{ path: '/admin/interest/preview', query: { id: id } }" class="name fl" v-else>
                                {{item.name}}
                            </router-link>
                        </div>
                    ...
                    <div class="option-box fr clearfix">
                        ...
                        <span class="btn-box" v-else>
                            ...
                            <a class="link" @click="redirect(pages.detail.interest, { query: { id: item.id } })" v-if="item.auditStatus == 1">进入兴趣组</a>
                        </span>
                    </div>
                </li>
            </ul>
