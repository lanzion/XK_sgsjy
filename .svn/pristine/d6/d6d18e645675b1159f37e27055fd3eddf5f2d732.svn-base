    ...
    <ul class="note-container">
      <li v-for="(note, index) in notes" :key="index" @mouseenter="mouseEnterItem(index)"
        ...
        <div v-else class="note-content table-cell">
          <p class="note-time">
            <i @click="jumpToSpecTime(note.playLength)" class="icon" :style="{"background-image": `url(${sup_small})`}"></i>
...
import suspendSmall from 'Asset/img/course/suspend_small.png'
