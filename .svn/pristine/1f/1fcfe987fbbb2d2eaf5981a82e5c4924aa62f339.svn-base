...
const state = {
    ...
    actorTypeOffLineDicList: {
        groupName: '参赛人群',
        model: 'actorTypeOffLine',
        dicList: [
            { id: '0', code: '0', name: '学生' },
            { id: '1', code: '1', name: '老师' }
        ]
    ...
    spaceTypeDicList: {
        ...
        model: 'spaceType',
        dicList: [
            { id: '1', code: '1', name: '学生空间' },
            { id: '2', code: '2', name: '教师空间' },
            { id: '3', code: '3', name: '班级空间' },
            { id: '5', code: '5', name: '学校空间' },
            { id: '6', code: '6', name: '区/县教育局空间' },
            { id: '7', code: '7', name: '市教育局空间' },
            { id: '8', code: '8',name: '省教育厅空间' },
        ]
    },
    // 转校状态
    transferStatusDicList: {
        groupName: '转校状态',
        model: 'transferStatus',
        dicList: [
            { id: '1', code: '1', name: '原校审核' },
            { id: '2', code: '2', name: '目的校审核' },
            { id: '3', code: '3', name: '完成' },
            { id: '4', code: '4', name: '拒绝' }
        ]
    },
...
const actions = {
    async getDictComb ({commit, state}, model) {
        let dicComb = state[`${model}DicList`] || {};
        if (dicComb.model === undefined || dicComb.model === null) {
            let response = await requestDictComb({ groupCode: model });
            let data = Object.assign({}, response.data.entity, {model: model})
