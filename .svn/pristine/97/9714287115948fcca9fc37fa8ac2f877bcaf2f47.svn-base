            ...
            <div class="main clearfix">
                ...
                <div class="content-right fl">
                    <div class="tag-wrapper">
                        <el-tag v-for="(tag, i) in curAchievementArr" :key="i" :closable="tag.id !== 'custom'" :close-transition="false" @close="deleteItem(tag.id)">
                            {{tag.worksName}}
                        </el-tag>
                        <a @click="worksWrapperIsVisible = !worksWrapperIsVisible" class="btn" href="javascript:;" title="关联作品">+ 关联</a>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            submit() { // 提交
                ...
                const options = this.module === 'practice'
                    ? practiceWorksArr
