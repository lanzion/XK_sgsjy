<template>
  <div :style="{fontSize: iconSize + 'px'}" class="operate">
    ...
    <a v-if="generateIcon('download')" :href="fileBaseUrl + downloadResource.id" :download="downloadResource.name" class="btn-download btn" title="下载"><i class="icon-btn-download icon"></i></a>
