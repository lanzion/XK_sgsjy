<template>
    <div>
        ...
        <el-table class="data-table back-stage-table" border :data="items" style="width: 100%" ref="multipleTable" @selection-change="changeSelection">
            ...
            <el-table-column prop="memberCount" label="成员" sortable width="100"></el-table-column>
...
<script>
    ...
    import { requestBaseInterest, requestInterestAuditRecord } from '@/service/admin_base.js'
