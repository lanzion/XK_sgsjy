    ...
    <div id="edu_activity">
        <div class="container listBox">
            ...
            <div class="screeningBox bgw mb20">
                ...
                <dl v-if="$route.path.startsWith('/street')" class="category-box category-input-box clearfix">
                    ...
                    <dt class="category-list clearfix">
                        ...
                        <el-select v-model="params.schoolName" placeholder="请选择学校" filterable clearable class="fl select-school"
			...
			<div class="activity-list bgw">
                ...
                <v-list :listData="listData" :linkTo="'/space/activity/details/info'"></v-list>
            </div>
