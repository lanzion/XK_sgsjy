<template>
    <div id="microClassDetail" class="container clearfix">
        <!-- 面包屑 -->
        <nav class="navigation container">
            <router-link :to="{path: `${pages.detail.studio.path}/microClass`, query: { id: detailsData.studioId }}"> 全部微课 </router-link> > 微课详情
        </nav>
