<template>
    <div id="resources">
        <div class="container listBox">
            ...
            <v-list :resourceData="resourceData" :linkTo="'/educationBureauSpace/resource/details'"></v-list>
...
export default {
    ...
    mounted(){
        this.getResourceList({'orgId': this.$route.query.id,'auditStatus':1})
    },
    computed: {
        params: function() {
    ...
    watch:{
        params:{
            handler:function(val,oldVal){
                switch (val.cur_tab){
                    case '1' :
                        this.getResourceList({'auditStatus':1,resourceType:val.resourceType,technology:val.technology,fileType:val.fileType,name:val.search,browseNum:1,orgId:this.$route.query.id});
                        break;
                    case '2' :
                        this.getResourceList({'auditStatus':1,resourceType:val.resourceType,technology:val.technology,fileType:val.fileType,name:val.search,praise:1,orgId:this.$route.query.id});
                        break;
                    case '3' :
                        this.getResourceList({'auditStatus':1,resourceType:val.resourceType,technology:val.technology,fileType:val.fileType,name:val.search,collection:1,orgId:this.$route.query.id});
                        break;
                    case '4' :
                        this.getResourceList({'auditStatus':1,resourceType:val.resourceType,technology:val.technology,fileType:val.fileType,name:val.search,shareNum:1,orgId:this.$route.query.id});
                        break;
                    case '5' :
                        this.getResourceList({'auditStatus':1,resourceType:val.resourceType,technology:val.technology,fileType:val.fileType,name:val.search,downNum:1,orgId:this.$route.query.id});
                        break;
                    case '6' :
                        this.getResourceList({'auditStatus':1,resourceType:val.resourceType,technology:val.technology,fileType:val.fileType,name:val.search,avgScore:1,orgId:this.$route.query.id});
                        break;
                    default:
                        this.getResourceList({'auditStatus':1,resourceType:val.resourceType,technology:val.technology,fileType:val.fileType,name:val.search,orgId:this.$route.query.id});
                }
            }
        }
    },
    methods: {
        ...
        changeTechnology(val){
            this.$set(this.$data, 'technology', val.id)
        },
        changeFormats(val){
            this.$set(this.$data, 'fileType', val.id)
        },
