<template>
    <div id="crowdCreation">
        ...
        <div class="container listBox">
            ...
            <div class="searchBox">
                <v-search @search="setSearchContent" tips="请输入众创空间名称"></v-search>
            </div>
...
import { requestMultSpaceList } from '@/service/space_multSpace.js'
export default {
    name: 'crowdCreation',
    components: {
        'v-banner': banner,
    ...
    methods: {
        ...
        // 请求列表数据
        getData: function () {
            requestMultSpaceList(this.params).then(response => {
