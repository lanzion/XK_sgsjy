    ...
    <div id="access" class="backend-content__middle">
        <el-form :model="form" ref="form" class="form">
            ...
            <el-form-item prop="authority" >
                <el-radio-group v-model="form.authority" @change="radioChange">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            requestAdd() {
                const authority = this.form.authority
                const blkUserId = this.form.blkUserId.map(i => i.id)
                const whtUserId = this.form.whtUserId.map(i => i.id)
        ...
        computed: {
            ...
            ...mapState('dictionaryCommon', {
                identityOptions(state) {
                    const dicList = (state.identityDicList || {}).dicList || []
                    return dicList
                }
            })
        }
