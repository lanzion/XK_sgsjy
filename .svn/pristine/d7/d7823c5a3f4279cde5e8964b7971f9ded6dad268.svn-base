        ...
        <el-form ref="form" :model="form" label-width="100px" :rules="rules">
            ...
            <el-row>
                <el-form-item label="链接名称" prop="linkName">
                    <el-col :span="8">
                        <el-input placeholder="请输入链接名称" v-model="form.linkName" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 所属栏目 -->
            <el-row>
                <el-form-item label="所属栏目" prop="linkType">
                    <el-col :span="8">
                        <el-select v-model="form.linkType" placeholder="请选择所属栏目" style="width:100%;" :disabled="isReadOnly">
                            <el-option
            ...
            <el-row>
                <el-form-item label="链接地址" prop="linkUrl">
                    <el-col :span="8">
                        <el-input placeholder="请输入链接地址" v-model="form.linkUrl" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 状态 -->
            <el-row>
                <el-form-item label="状态" prop="status">
                    <el-col :span="8">
                        <el-switch v-model="linkStatus" on-text="" off-text="" :disabled="isReadOnly"></el-switch>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 打开类型 -->
            <el-row>
                <el-form-item label="打开类型" prop="targetType">
                    <el-col :span="8">
                        <el-radio-group v-model="form.targetType" :disabled="isReadOnly">
            ...
            <el-row>
                <el-form-item label="链接说明" prop="linkDesc">
                    <el-col :span="10">
                        <el-input type="textarea" v-model="form.linkDesc" placeholder="请输入链接说明" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 链接图片 -->
            <el-row>
                <el-form-item label="链接图片" prop="linkImg">
                    <el-col :span="14">
                        <el-upload class="cover-uploader fl" :show-file-list="false" action :before-upload="UploadFile" :disabled="isReadOnly">
            ...
            <el-form-item v-else>
                <button class="bs-form-button i-form-button" type="button" @click="onSubmit('form')">{{ form.id?'保存':'发布'}}</button>
                <button class="bs-form-button i-form-button is-plain" @click="$router.go(-1)">取消</button>
            </el-form-item>
        </el-form>
    </div>
</template>
