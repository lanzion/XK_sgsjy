  ...
  <div id="resourcesDetails">
    ...
    <div class="preview-msg backend-content__middle">
    	<section class="resource-msg">
            <div class="resource-content">资源名称：{{detailsData.name}}</div>
        		<div class="resource-content">资源简介：{{detailsData.introduction}}</div>
        		<div class="resource-classify"><span class="w56 text-justify">分类</span>：{{detailsData.resourceTypeName}}</div>
        		<div class="resource-technology"><span class="w56 text-justify">技术</span>：{{detailsData.technologyName}}</div>
        		<div class="resource-technology"><span class="w56 text-justify">来源</span>：{{sourceType[detailsData.source]}}</div>
...
<script>
    ...
    import docReader from '@/components/space/resource/doc_reader.vue'
