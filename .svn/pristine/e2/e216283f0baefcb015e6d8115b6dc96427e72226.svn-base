<template>
    <div id="investors">
        ...
        <div class="container listBox">
            ...
            <div class="searchBox">
                <v-search @search="setSearchContent" tips="请输入投资人名称"></v-search>
            </div>
...
import { requestInvestorList } from '@/service/space_Investor.js'
export default {
    name: 'investors',
    components: {
        'v-banner': banner,
    ...
    methods: {
        ...
        // 请求列表数据
        getData: function () {
            requestInvestorList(this.params).then(response => {
