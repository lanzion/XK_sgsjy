                ...
                <li class="list-item table-layout" v-for="(item, index) in contestList">
                    ...
                    <div class="msg-box table-cell">
                        <h4 class="contest-name">
                            <a href="javaScript:;" @click="redirect(pages.detail.contestReview, { query: { id: item.id, type: item.matchType } })">{{item.title}}</a>
                        </h4>
                    ...
                    <div class="btn-box table-cell">
                        ...
                        <div class="to-detail">
                            <a href="javaScript:;" @click="redirect(pages.detail.contestReview, { query: { id: item.id, type: item.matchType } })">去评审</a>
                        </div>
                    </div>
                </li>
            </ul>
