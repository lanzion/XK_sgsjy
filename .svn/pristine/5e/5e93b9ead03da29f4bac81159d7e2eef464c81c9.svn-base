<template>
    <div class="projectManage backend-content__middle">
        ...
        <v-regionSelect :defaultItems.sync="region" style="width:172px;display:inline-block;margin-left:20px;"></v-regionSelect>
...
import regionSelect from 'Common/select/region_select.vue'
