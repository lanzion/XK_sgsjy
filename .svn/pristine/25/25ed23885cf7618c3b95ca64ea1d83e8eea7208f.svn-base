    ...
    <div class="manage-point__content">
      ...
      <transition name="fade" mode="out-in">
        ...
        <div v-else class="edit-point__wrapper transition-group">
          ...
          <div class="btn-row">
            <button @click.stop="cancelEditing" class="btn-cancel btn">取消</button>
  ...
  export default {
    ...
    methods: {
      ...
      append (store, data) { // 添加子知识点，data可以访问到当前节点数据，作为子知识点的父级数据
        let _curPoint = {name: '请输入知识点', subs: [], parentId: data.id}
        const MAXLENGTH = 3
