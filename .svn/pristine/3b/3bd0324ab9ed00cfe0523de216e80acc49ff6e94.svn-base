<template>
    <section id="subject_discuss">
        ...
        <router-link v-if="isCreater || isMember" class="initiateTheme" :to="{ path: 'initiate', query: {id:$route.query.id ? $route.query.id : '',subjectId: $route.query.subjectId} }"><i class="i-initiateTheme"></i>发起主题</router-link>
        <div class="allTopics">
