...
let moreLink = {
    path: '/educationBureauSpace/subject/:model',
    params: 'model'
}
export default {
    name: 'subject',
            ...
            modelList: [
                {
                    ...
                    items: [],
                    details: {
                        path: '/educationBureauSpace/subject/guide/detail',
                        query: 'guideId'
                    }
                },{
                    tabs: [
                    ...
                    items: [],
                    details: {
                        path: '/educationBureauSpace/subject/activity/detail',
                        query: 'activityId'
                    }
                },{
                    tabs: [
                    ...
                    items: [],
                    details: {
                        path: '/educationBureauSpace/subject/results/detail',
                        query: 'resultId'
                    }
                }
            ],
