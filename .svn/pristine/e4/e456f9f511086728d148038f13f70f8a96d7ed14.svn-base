                ...
                <el-row>
                    <el-form-item label="兴趣组头像" style="position:relative;" required>
                        <el-col :span="14">
                            ...
                            <div class="upload-tips fl" style="color:#8391a5;">
...
<script>
    ...
    export default{
        ...
        mounted() {
            ...
            this.isManage = this.$route.path.includes('interest')
            this.getSelect()
        },
        methods: {
            // 获取技术select的options
