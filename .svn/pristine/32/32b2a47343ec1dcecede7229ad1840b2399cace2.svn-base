...
<script>
  import stepOne from '@/components/evaluation/add_tmpl_step1.vue'
  import stepTwo from '@/components/evaluation/add_tmpl_step2.vue'
  import stepThree from '@/components/evaluation/add_tmpl_step3.vue'
  import stepFour from '@/components/evaluation/add_tmpl_step4.vue'
