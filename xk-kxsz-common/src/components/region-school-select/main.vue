<template>
    <div>
        <el-popover popper-class="select-popover" ref="popoverSelect" :visible-arrow="false" v-show="!disabled" v-model="spVisible" placement="bottom-start" :width="popperWidth>400?popperWidth:400" trigger="click">
            <el-row :gutter="10" class="select-popover-search">
                <el-col :span="16">
                    <v-region-select :defaultItems="defaultItems" @region="changeRegion" :isAdmin="isAdmin" ref="region"></v-region-select>
                </el-col>
                <el-col :span="8">
                    <el-input placeholder="关键字" icon="search" v-model="schoolForm.schoolName" :on-icon-click="searchSchool" ref="search"></el-input>
                </el-col>
            </el-row>
...
<script>
    import region from './../region-select/main.vue'
    import { requestSchoolList } from './../../service/common.js'

    export default {
        name: 'xk-region-school-select',
        components: {
