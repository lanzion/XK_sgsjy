<template>
    <el-table class="data-table back-stage-table" border :data="items" style="width: 100%" ref="multipleTable" @selection-change="changeSelection">
        ...
        <el-table-column prop="projectName" label="项目类别" show-overflow-tooltip></el-table-column>
        <!-- <el-table-column prop="schoolName" label="辅导机构"></el-table-column>
        <el-table-column prop="address" label="机构地址" show-overflow-tooltip></el-table-column> -->
