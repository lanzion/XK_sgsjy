<template>
    <el-dialog :visible.sync="visible.show" class="feedback-dialog" @close="close">
            ...
            <el-form ref="form" :model="form" label-width="80px" :rules="rules">
                ...
                <el-row>
                	<el-form-item label="验证码" required>
                		<el-col :span="18">
                			<el-input placeholder="请输入验证码" @blur="codeVerify" class="verify-input" v-model="code"></el-input>
        ...
        methods: {
            codeVerify() {
                if (this.code.trim() === '') {
                    ...
                    this.verifyTips = '请输入验证码'
                } else {
                    const self = this
                    const res = verifyCode.validate(self.code.trim())
                    if (res) {
