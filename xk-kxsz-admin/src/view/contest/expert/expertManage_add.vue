        ...
        <el-form ref="form" :model="form" label-width="100px" :rules="rules">
            ...
            <el-row>
                <el-form-item label="区域" prop="region">
                    <el-col :span="8">
                        <v-region-select :defaultItems.sync="region" class="select-region" :disabled="true"></v-region-select>
                    </el-col>
                </el-form-item>
            </el-row>
            <el-row>
...
import expertTeacher from '@/components/contest/select_expert_teacher.vue'
