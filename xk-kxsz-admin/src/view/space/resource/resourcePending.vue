...
<script>
    ...
    import { requestResourcesAuditList, requestResourcesAudit, requestResourceCancelAudit } from '@/service/admin_space.js'  // 列表数据接口
    ...
    export default {
        ...
        methods: {
            ...
            // 撤销审核
            cancelAudit(item) {
                this.$confirm('此操作将撤销该资源的审核，是否继续？', '提示', {
                    ...
                    const params = {
                        id: item.data.resourceId
                    }
                    requestResourceCancelAudit(params).then((res) => {
                        if (res.data.code === 200) {
