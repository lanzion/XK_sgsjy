...
<template>
    <div>
            ...
            <div v-show="screeningDropdown" class="bs-screening_wrap">
                <el-form :inline="true" :model="dataParams" class="bs-screening_box">
                    <el-form-item label="类目">
                        <el-select v-model="dataParams.category" placeholder="请选择学段" clearable>
        ...
        <el-table class="data-table back-stage-table" border :data="items" style="width: 100%" ref="multipleTable" @selection-change="changeSelection">
            ...
            <el-table-column prop="name" label="服务标题" show-overflow-tooltip width="200">
...
<script>
    ...
    import { requestServiceAuditList, requestServiceAudit, requestServiceCancelAudit } from '@/service/admin_space.js'  // 列表数据接口
    ...
    export default {
        ...
        methods: {
             ...
             */
            getData() {
                requestServiceAuditList(this.dataParams, this.pageParam).then(response => {
                    if (response.data.code == 200) {
            ...
            auditSubmit (item) {
                ...
                requestServiceAudit(this.AuditParams).then(res => {
