        ...
        <el-form ref="form" :model="form" label-width="120px" :rules="rules">
            ...
            <el-row>
                <el-form-item label="企业名称" prop="name">
                    <el-col :span="8">
                        <el-input v-model="form.name" placeholder="请输入企业名称" :disabled="isReadOnly"></el-input>
                    </el-col>
                </el-form-item>
            </el-row>
            <!-- 工商注册号码 -->
...
import { addBaseEnterprise, requestEnterpriseDetail, modifyBaseEnterprise } from '@/service/admin_base.js'
...
export default {
    ...
    data() {
        ...
        var validateUserName = (rule, value, callback) => {
            ...
            if (value === '') {
                ...
                callback(new Error(`您输入的企业全称格式不正确`))
            } else {
                callback()
            }
        }
    ...
    methods: {
        ...
        //获取企业详情
        getDetail(){
            requestEnterpriseDetail({id:this.form.id}).then((res) => {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    let flag = this.$route.query.id ? true : false,
                        handle = flag ? modifyBaseEnterprise : addBaseEnterprise,
