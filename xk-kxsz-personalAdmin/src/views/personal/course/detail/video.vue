                ...
                <div class="video-box fl">
                    <div class="wrapper">
                        ...
                        <transition name="fade">
                            <div v-show="videoHasPaused" @click.stop="togglePlay" class="btn-start" :style="{'background-image': `url(${btn_start})`}"></div>
                        </transition>
                    </div>
                    <div class="bottom">
                    ...
                    <a @click="foldRightPanel" class="btn-folder" :style="{'background-image': `url(${btn_folder})`}" href="javascript:;"></a>
                </div>
...
<script>
    ...
    import repairVideo from '@/components/course/repairVideo.vue'
    import courseDetail from 'components/course/video/videoCourseDetail.vue'
    import outline from 'components/course/video/outline.vue'
    import note from 'components/course/video/note.vue'
    // import iconError from 'Asset/img/course/icon_error.png'
    import btnStart from 'Asset/img/course/btn_start.png'
    import btnFolder from 'Asset/img/course/btn_folder.png'
    ...
    export default {
        ...
        methods: {
            ...
            addCourseStudyingRecord() { // 添加视频学习进度
                ...
                const videoCurTime = videoEl ? +(videoEl.currentTime / 60).toFixed(2) : 0 // 视频当前播放时间点
                const sum = videoEl ? +(videoEl.duration / 60).toFixed(2) : 0
