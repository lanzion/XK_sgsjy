...
<script>
  ...
  import courseIntro from 'components/course/intro.vue' // 课程介绍
  import aside from 'components/course/aside.vue' // 课程侧边栏
  import { scrollToTop } from 'Asset/js/scrollToTop.js'
