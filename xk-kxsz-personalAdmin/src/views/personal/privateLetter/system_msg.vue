    ...
    <section id="system_msg" class="my-letter">
        <div class="del-batch" v-if="msgData.length > 0">
            ...
            <el-popover ref="popover" placement="top" width="140" v-model="visible">
                  ...
                  <div style="text-align: right; margin: 10px">
                    ...
                    <button class="psn-confirm-btn" @click="delMessage">确定</button>
                  </div>
            </el-popover>
        ...
        <el-dialog title="系统提示" :visible.sync="invitePopup" size="tiny" :before-close="close" class="invitePopup">
            ...
            <div class="button_group">
                <button type="button" class="psn-cancel-btn" @click="close">取消</button>
                <button type="button" class="psn-confirm-btn" @click="sendInvite">参加</button>
            </div>
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            sendInvite() {
                const messageType = this.inviteMsg.messageType
                const busId = this.inviteMsg.busId
                const _this = this
