        ...
        <ul>
          <list-row v-for="(item, index) in lists" :item="item" :item-height="isStudent ? 186 : 140"
            ...
            <div slot="content" class="content table-cell">
              ...
              <p>开始学习时间：{{item.createDate | dateFormat('yyyy-MM-dd hh:mm:ss')}}</p>
              ...
              <p>学习成果：
                <a v-for="(result, i) in item.studyResultList" :key="i" :title="result.worksName"
              ...
              <div slot="operate" class="operate pa">
                ...
                <a @click="redirect(pages.detail[dynamicLinks.link], { query: { id: item.busId } })" class="link">继续学习
                </a>
...
import selectRange from '@/components/dialog/study/set_range_dialog.vue'
import achievementDialog from '@/components/dialog/study/achievement_dialog.vue'
