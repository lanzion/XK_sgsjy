    ...
    <div id="worksList">
            ...
            <li v-for="(item,index) in datas" class="clearfix">
                ...
                <div class="msg-box fl">
                    ...
                    <p class="works_msg">
                        ...
                        <span v-if="auditStatus == 1">&nbsp;&nbsp; <i class="icon-btn-i-share"></i> {{item.shareCount ? item.shareCount : 0}}</span>
                    </p>
                </div>
        ...
        <el-dialog title="可评范围" :visible.sync="openRangePopup" size="tiny">
            ...
            <div class="buttonGroup clearfix">
                <a class="psn-confirm-btn" @click="openRangePopup = false">取消</a>
                <a class="psn-cancel-btn" @click="setOpenRange">确定</a>
            </div>
        </el-dialog>
...
<script>
    ...
    export default {
        ...
        mounted() {
            const user = this.$ls.get('userIdentity')
            if (user === 'teacher') {
        ...
        computed: {
            params: function () {
                return Object.assign({}, this.selected, { earch: this.search }, { auditStatus: this.auditStatus })
            }
        },
        watch: {
            $route: 'routeChange',
