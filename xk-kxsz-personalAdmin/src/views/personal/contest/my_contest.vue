            ...
            <ul class="list-box" v-if="contestList.length">
                <li class="list-item table-layout" v-for="(item, index) in contestList">
                    <div class="img-box table-cell">
                        ...
                        <div class="label">
                            <p :class="[`status_${item.enrollStatus}`]">{{item.enrollStatus | translate(enrollStatusDL)}}</p>
                    ...
                    <div class="msg-box table-cell">
                        <h4 class="contest-name">
                            <a href="javaScript:;" @click="redirect(pages.detail.contest, { query: { id: item.id, type: item.matchType } })">{{item.title}}</a>
                        </h4>
                    ...
                    <div class="btn-box table-cell">
                        ...
                        <div class="to-detail">
                            <a href="javaScript:;" @click="redirect(pages.detail.contest, { query: { id: item.id, type: item.matchType } })">前往参加</a>
                        </div>
                    </div>
                </li>
            </ul>
...
<script>
    ...
    import { myContest } from '@/service/contest.js'
    ...
    export default {
        ...
        methods: {
            ...
            getMyContest() {
                myContest({ title: this.search }, this.param).then((res) => {
