        ...
        <div class="table-box">
            <el-table class="data-table" :data="stageList" style="width: 100%" border>
                ...
                <el-table-column prop="taskTime" label="通过时间">
                    <template slot-scope="scope">{{ scope.row.endDate | dateFormat('yyyy.MM.dd') }}</template>
                </el-table-column>
...
<script>
    import stageInitiate from 'components/subject/stage_initiate.vue'
    import stageDetail from 'components/subject/stage_detail.vue'
