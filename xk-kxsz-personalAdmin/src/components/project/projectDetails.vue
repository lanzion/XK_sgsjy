<template>
	<div id="projectDetails" class="projectDetails">
		...
		<div class="clearfix">
            ...
            <div class="content_r">
                <h4 class="content_r_title clearfix"><span class="fl">相关项目</span><span class="more fr" @click="toMore">更多>></span></h4>
...
export default {
    ...
    methods: {
        ...
        toMore(){
            const url = `${location.protocol}//${location.host}/${this.pages.list.project}`
