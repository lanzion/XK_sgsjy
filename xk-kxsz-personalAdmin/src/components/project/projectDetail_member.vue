...
<script>
import pendingMemberList from 'Common/classificationList/list/text/pendingMemberList.vue'
import auditedMemberList from 'Common/classificationList/list/graphic/auditedMemberList.vue'
