<template>
    <div id="InvInstitutions">
        ...
        <div class="container listBox">
            ...
            <div class="searchBox">
                <v-search @search="setSearchContent" tips="请输入投资机构名称"></v-search>
            </div>
...
import { requestInvestOrgList } from '@/service/space_investOrg.js'
export default {
    ...
    methods: {
        ...
        // 请求列表数据
        getData: function () {
            requestInvestOrgList(this.params).then(response => {
