    ...
    <div id="interestsSpace" class="interestsSpace container clearfix">
        ...
        <div class="about-interests bgc_w clearfix">
            ...
            <div class="btn-box clearfix">
                ...
                <router-link v-if="isAdmin" class="to-manage fl" :to="{path:'/interestManage/baseInfo',query:{ id: $route.query.id, interest: interestsDetail.name }}">兴趣组管理</router-link>
            </div>
        </div>
...
export default {
    ...
    data () {
        return {
            ...
            navList: [
                {
                    name: '主页',
                    path: '/interestsSpace/homePage'
                },{
                    name: '作品',
                    path: '/interestsSpace/works'
                },{
                    name: '话题',
                    path: '/interestsSpace/topic'
                },{
                    name: '文章',
                    path: '/interestsSpace/article'
                },{
                    name: '成员',
                    path: '/interestsSpace/member'
                },{
                    name: '资源',
                    path: '/interestsSpace/resource'
                }
            ],
            intMes: [
    ...
    created(){
        ...
        if (this.$ls.get('loginInfo')) {
            ...
            this.hadLogin = true;
            let identity = this.$ls.get('userIdentity');
                    ...
                    if (this.interestsDetail !== null && this.interestsDetail.status === 0) {
                        this.$alert('该兴趣组已解散', '温馨提示', {
                            ...
                            callback: action => {
                                ...
                                window.location.href = `${location.protocol}//${location.host}#/space/interest`
                            }
                        });
