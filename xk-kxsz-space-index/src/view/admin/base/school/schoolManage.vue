<template>
    <div class="backend-content__middle">
        ...
        <el-table class="data-table back-stage-table" border :data="items" style="width: 100%" ref="multipleTable" @selection-change="changeSelection">
            ...
            <el-table-column prop="identityCode" label="编码" width="140" sortable show-overflow-tooltip></el-table-column>
            ...
            <el-table-column label="操作" fixed="right" width="580">
                <template scope="scope">
        ...
        <el-dialog class="detailsOnStage" :visible.sync="backgroundVisible" size="small" title="更换背景">
            <v-bgcPopup :background="background" :close="close" :save="setBackground" @changeBackground="changeBackground"></v-bgcPopup>
        </el-dialog>
        <!-- 更改空间实景 -->
        <el-dialog class="detailsOnStage" :visible.sync="sceneVisible" size="small" title="创客空间图片">
            <v-spaceScene :scene="scene" @getSceneList="getSceneList" :businessId="curId" :close="close"></v-spaceScene>
        </el-dialog>
    </div>
</template>
...
<script>
    ...
    import spaceScene from 'components/admin/backstage/backgroundOption/spaceScene.vue'
