...
<script>
  ...
  import categoryDialog from '@/components/admin/model_school/add_achievement_category.vue'
  import achievementDialog from '@/components/admin/model_school/add_achievement_dialog.vue'
