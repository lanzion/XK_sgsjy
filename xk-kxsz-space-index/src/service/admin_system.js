...
/******************************************Banner**********************************************/
// Banner列表
let requestSystemBanner = (options = {}) => xhr.post('/maker/banner/getAllBanner', options)
// 添加Banner
let addBanner = (options = {}) => xhr.post('/maker/banner/addFile', options)
// 删除Banner
let delBanner = (options = {}) => xhr.post('/maker/banner/delFile', options)
// 添加banner关系
let addBannerRelation = (options = {}) => xhr.post('/maker/banner/add', options)
// 删除banner关系
let delBannerRelation = (options = {}) => xhr.post('/maker/banner/del', options)
// 修改banner顺序
let updateBannerSort = (options = {}) => xhr.post('/maker/banner/updateSort', options)
// 设置banner轮播时间
let updateBannerTime = (options = {}) => xhr.post('/maker/banner/updateBannerTime', options)
