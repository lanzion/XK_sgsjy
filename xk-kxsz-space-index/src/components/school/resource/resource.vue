<template>
  <div id="school_resource">
    <div class="container listBox">
      ...
      <v-list :resourceData="resourceData" :linkTo="'/schoolSpace/resource/details'"></v-list>
      ...
      handler:function(val,oldVal){
        switch (val.cur_tab){
          ...
          case '6' :
            ...
            break;
          default:
            this.getResourceList({'auditStatus':1,resourceType:val.resourceType,technology:val.technology,fileType:val.fileType,search:val.search,orgId:this.$route.query.id});
        }
      }
    }
  },
