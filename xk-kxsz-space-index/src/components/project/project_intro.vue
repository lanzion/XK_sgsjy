<template>
    <article id="projectIntro" class="projectIntroPanel clearfix">
        <div :class="[ifAdmin ? 'projectIntroAdmin':'projectIntroPrev']" title="点击查看原图" @click="visible.show = true" :style="{backgroundImage:'url('+ getFileUrl((projectDetail.imgUrl?projectDetail.imgUrl:null))+')'}"></div>
