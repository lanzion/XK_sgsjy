...
export default {
    ...
    methods: {
        ...
        collectItem() {
            this.ifLogin()
            if(this.loginStatus) {
                let url = this.isEvent.isCollection ? 'maker/common/collection/cancel' : 'maker/common/collection/do';
                this.$http.post(url,
                    {
                        "busId": this.id,
                        "userId": this.loginInfo.userInfo.id,
        ...
        praiseItem() {
            this.ifLogin()
            if(this.loginStatus) {
                let url = this.isEvent.isPraise ? 'maker/praise/cancel' : 'maker/praise/do';
                this.$http.post(url,
                    {
                        "busId": this.id,
                        "userId": this.loginInfo.userInfo.id,
