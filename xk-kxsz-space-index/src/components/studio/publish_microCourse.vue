<template>
	<el-dialog :visible.sync="visible.show" id="publish_microCourse" title="发布微课" class="dialog" @close="close">
...
<script>
	...
	import { requestTypeList, addStudioClassroom, modifyStudioClassroom, requestMicroClassDetail } from '@/service/studio.js';
	export default{
