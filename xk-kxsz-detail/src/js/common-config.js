...
module.exports = {
    ...
    pages: {
        ...
        detail: {
            ...
            subject: {
                url: `${host}/detail/#/space/subject/research/info`,
                path: '/space/subject/research',
                type: 1
            },
            studyEval: {
                url: `${host}/detail/#/space/student/study/eval`,
                path: '/space/student/study/eval',
                type: 1
            },
            practiceEval: {
                url: `${host}/detail/#/space/student/practiceEval`,
                path: '/space/student/practiceEval',
                type: 1
            }
        },
        list: {
            ...
            teacher: {
                url: `${host}#/space/teacher`,
                type: 2
            },
            student: {
                url: `${host}#/space/student`,
                type: 2
            },
            edu: {
                url: `#/space/edu`,
