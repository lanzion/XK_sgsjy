...
// 兴趣组-个人后台列表
let requestMyInterestList = (options = {},pageParams = {}) => xhr.post(`/maker/space/interests/listPagerbyAudit?pageNum=${pageParams.pageNum}&pageSize=${pageParams.pageSize}`,options)
...
// 兴趣组-文章-修改
let articleEdit = (options = {}) => xhr.post(`/maker/interests/article/modify`,options)
// 兴趣组-文章-详情
