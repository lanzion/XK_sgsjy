        ...
        <div class="upload-resource__content">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                <el-form-item label="选择资源" prop="selected">
                    <el-select v-model="form.selected" :filterable="true" :clearable="true" no-data-text="您的资源库暂无资源，请先上传" popper-class="upload-resource__dropdown" placeholder="请选择资源">
                        <el-option v-for="(item, i) in resourceList" :key="i" :label="item.resourceName" :value="item._i"></el-option>
                    </el-select>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        methods: {
            async requestList() { // 获取学员列表
                const res = await requestResourceList({ auditStatusTeaOrStu: 1 }, { pageSize: 999, pageNum: 1 })
