<template>
	<div class="thu_carsou">
		<el-carousel height='313px' :autoplay="false" @change="changeBanner" ref="banner" indicator-position="none" arrow="never">
            <el-carousel-item v-for='(item, index) in imgs' :key="index">
                <div class='banner-img' title="点击查看原图" @click="viewImgs" :style='{"background-image": "url(" +getFileUrl(item.resourceId)+ ")"}'></div>
            </el-carousel-item>
        </el-carousel>
