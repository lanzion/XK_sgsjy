<template>
	<div class="view-box" v-if="visible.show" @click="closeView">
		...
		<el-carousel :height="`${fullHeight}px`" :interval="5000" ref="img" indicator-position="none" :autoplay="true" v-if="ifCarousel">
            <el-carousel-item v-for='(item, index) in imgs' :key="index">
                <img :src="getFileUrl(item[imgKey]) || listDefault" class="imgs" title="点击返回">
            </el-carousel-item>
        </el-carousel>
