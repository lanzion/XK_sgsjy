                ...
                <div class="el-table__body-wrapper">
                    <table cellspacing="0" cellpadding="0" border="0" class="el-table__body" style="width: 100%;">
                        ...
                        <tr v-if="evalType === '1' && !isAdmin" class="">
                            ...
                            <td class="">
                                <ul class="cell table-content clearfix" v-if="achievementList && achievementList.length">
    ...
    export default {
        ...
        computed: {
            achievementList() { // 学习、实践的成果列表
                ...
                return this.isAdmin ? myEvalResultList || this.curEvaluatingItem.resultList : myEvalResultList || this.curEvaluatingItem.resultList
            },
...
//            _isFinal && this.requestFinalList()
        ...
        methods: {
            ...
            async queryEvalResult() { // 查询评价结果
                ...
                const res = await queryEvalResult({ busId, target })
