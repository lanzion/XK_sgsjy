        ...
        <div class="plate">
            ...
            <ul class="plate_ul"><p class="list_p"></p>
                <router-link :to="{ path:'theme', query:{'id': $route.query.id, 'discussType': '2'} }">
                    <li class="plate_list"><i class="icon icon-answer" :style="{ 'background-image': `url(${answerBg})` }"></i><p class="list_p1">教师答疑区</p><p class="list_p2">在这里，项目成员可以发表关于项目的相关问题，并得到教师的解答。</p></li>
                </router-link>
                <router-link :to="{ path: 'theme', query:{'id': $route.query.id, 'discussType': '1'}  }">
                    <li class="plate_list"><i class="icon icon-discuss" :style="{ 'background-image': `url(${discussBg})` }"></i><p class="list_p1">综合讨论区</p><p class="list_p2">在这里，大家可以一起交流项目经验。</p></li>
                </router-link>
            </ul>
        </div>
        <div class="allTopics">
                ...
                <li class="allTopics_list clearfix" v-for="(item,index) in data" :key="index">
                    ...
                    <div class="content-reply">
                        ...
                        <p class="allTopics_p3 clearfix">
                            <el-tag class="fl" type="primary" size="mini" v-if="item.discussType == 1">综合讨论区</el-tag>
                            <el-tag class="fl" type="success" size="mini" v-else>教师答疑区</el-tag>
...
<script>
import answerPng from '../../assets/img/common/answer.png'
import discussPng from '../../assets/img/common/discuss.png'
