            ...
            <section class="topic_list">
                <div class="list-header clearfix">
                    <div class="msg-box fr clearfix" style="color:#3e3e3e;font-size: 16px;">
                        ...
                        <div class="fl" style="width:100px;" v-if="isAdmin">
                            <p class="name">操作</p>
                        </div>
                    </div>
                </div>
                <ul v-if="topicDatas.length > 0">
                    <li class="clearfix" v-for="(item,index) in topicDatas" :key="index">
                        ...
                        <div class="msg-box fr clearfix">
                            ...
                            <div class="option fl" v-if="isAdmin">
...
<script>
    ...
    import { requestTopicList, addTopic, topicIsHot } from '@/service/topic.js'
    ...
    export default {
        ...
        created() {
            if (this.$route.path.includes('clasz')) {
                this.topicType = '1'
            } else {
                this.topicType = '2'
            }
        ...
        methods: {
            ...
            getTopicList() {
                const datas = {
                    ...
                    isHot: this.cur_tab.toString() === '1' ? this.cur_tab.toString() : ''
                }
                requestTopicList(datas, { pageSize: 10, pageNum: this.param.pageNum }).then((res) => {
