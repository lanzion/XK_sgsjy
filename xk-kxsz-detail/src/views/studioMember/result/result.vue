<template>
    <div class="studioArticle container clearfix">
        ...
        <!-- 发布修改 -->
        <el-dialog title="发布成果" :visible.sync="pubVisible" size="small" :before-close="closePopup" lock-scroll>
            <el-form :model="form" :rules="rules" ref="form" label-width="80px">
                ...
                <el-form-item>
                    <el-col :span="22" style="text-align: right;" class="group_btn">
                        <button class="btn cancel" @click.prevent="pubVisible = false;closePopup()">取消</button>
