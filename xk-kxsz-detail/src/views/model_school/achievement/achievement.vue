    ...
    <div class="achievement-wrapper listBox clearfix">
        ...
        <div class="main bgw">
            ...
            <ul class="achievement-list">
                <li v-for="(item, idx) in list" :key="idx" :title="item.name" class="achievement-item clearfix">
                    <router-link :to="{path: `${pages.detail.model.path}/achv/detail`, query: { id: item.id, orgId: $route.query.id }}">
...
<script>
    import { requestAchievementList } from '@/service/model_school.js'
