<template>
    <div class="container information">
        <div class="mes bgc_w">
            <v-tabs :tabs="tabs" :cur_tab='curId' :count="count" :is_search="true" @searchVal="changeSearch" :total="page.totalNum" @cur_tab="listenCurTab"></v-tabs>
...
export default {
    ...
    computed: {
        params() {
            return Object.assign({ noticeTypeId: this.tabs[this.curId].id, title: this.search, orgId: this.$route.query.id }, this.pageParam)
        }
    },
    mounted() {
