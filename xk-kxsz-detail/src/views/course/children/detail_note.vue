<template>
    <div class="note-wrapper">
        ...
        <div class="note-main">
            ...
            <add-note-dialog v-if="dialog.isVisible" :dialog="dialog" :sections="sections" :handle-request="requestNoteList" :cur-editing-note="curEditingNote"></add-note-dialog>
        </div>
    </div>
</template>
...
<script>
    ...
    import addNoteDialog from 'Common/module/course/add_note_dialog.vue'
