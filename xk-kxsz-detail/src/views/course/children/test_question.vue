<template>
    <div class="question-wrapper test-wrapper">
            <ul class="questions">
            ...
            async submitTest() { // 提交试卷
                if (this.questions.length === 0) {
                    ...
                    this.$message({
                        ...
                        duration: 2000,
                        onClose() {
                            component.$router.push({ path: '/education/course/outline', query: { id: component.$route.query.id } })
                        }
                    })
                    return
                }
                ...
                try {
                    ...
                    if (res.data.code === 200) {
                        this.$router.push({ path: '/education/course/test/a', query: this.$route.query })
                        return
                    }
