        ...
        <div class="discuss_content">
            <div class="theme report">
                <div class="theme_title">
                    <p>
                        {{theme.title}}
                        <v-report class="fr" :report-data="{'url': reportApi, params: {'discussId': theme.id}}"></v-report>
                        <el-tag class="ml10" type="primary" size="mini" v-if="theme.discussType == 1">综合讨论区</el-tag>
                        <el-tag class="ml10" type="success" size="mini" v-else>教师答疑区</el-tag>
                    </p>
                    <p class="theme_content" v-html="theme.content || '---'"></p>
                    <p><span class="theme_author">{{theme.createName}}</span> <span
                        class="theme_time">{{theme.createDate | dateFormat('yyyy-MM-dd HH:mm:ss')}}</span>
                    </p>
                </div>
                ...
                <div class="reply">
                    ...
                    <div class="buttonGroup clearfix">
                        <button class="reply_btn reply_btn1" @click="reply({pId: $route.query.pId, index: -1})">发表</button>
                    ...
                    <div class="content-reply">
                        <section class="allTopics_list_item report">
                            <p class="allTopics_p2 ">
                                ...
                                <v-report class="fr" :report-data="{'url': reportApi, params: {'discussId': item.id}}"></v-report>
                            </p>
                            ...
                            <div class="allTopics_p3">
                                ...
                                <div class="reply" v-if="item['_isVisible']">
                                    ...
                                    <div class="buttonGroup clearfix">
                                        <button class="reply_btn reply_btn1" @click="reply({pId: item.id, _txt: item._txt, index})">发表</button>
                                        <button class="reply_btn reply_btn2" @click="item['_isVisible'] = false">取消</button>
                                    </div>
                                </div>
                            </div>
                        </section>
                            ...
                            <li v-for="(i,k) in item.childBean.resultData" :key="k" class="allTopics_list2 clearfix report">
                                ...
                                <div class="content-reply">
                                    <p class="allTopics_p2">
                                        ...
                                        <v-report class="fr" :report-data="{'url': reportApi, params: {'discussId': i.id}}"></v-report>
                                    </p>
                                    ...
                                    <div class="allTopics_p3">
                                        ...
                                        <div class="reply" v-if="i['_isVisible']">
                                            ...
                                            <div class="buttonGroup clearfix">
                                                <button class="reply_btn reply_btn1" @click="reply({pId: item.id, _txt: i._txt, index})">发表</button>
                                                <button class="reply_btn reply_btn2" @click="i['_isVisible'] = false">取消</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
