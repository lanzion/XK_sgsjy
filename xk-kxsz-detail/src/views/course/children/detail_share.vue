        ...
        <el-table class="data-table" :data="resourceList" style="width: 100%" border>
            ...
            <el-table-column label="操作" width="160" align="center">
                <template slot-scope="scope">
                    <operate @on-delete="delResource(scope.row.id)" @on-edit="editItem(index)" :icon-group="generateIcons()" :download-resource="{'id': scope.row.resourceId, 'name': scope.row.resourceName, 'fileExt': scope.row.fileExt}" label="资源"></operate>
                </template>
            </el-table-column>
        </el-table>
...
<script>
    ...
    import uploadResource from 'components/common/module/course/upload_resource_dialog.vue'
