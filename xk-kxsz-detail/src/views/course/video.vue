...
<script>
    ...
    import repairVideo from 'View/course/video/repairVideo.vue'
    ...
    export default {
        ...
        computed: {
            ...mapGetters('course', ['videoSrcArr', 'sectionsList']),
            ...
            curSectionIndex() {
                return this.sectionsList.findIndex(item => item.sectionId === this.$route.query.sectionId) || 0
            }
        },
        components: {
            courseDetail,
        ...
        methods: {
            ...
            handleEnd() { // 视频播放结束，是否自动播放下一视频
                const nextIndex = this.curSectionIndex + 1
                if (nextIndex < this.sectionsList.length && this.sectionsList[nextIndex].sectionType !== '1') {
                    const query = {
                        id: this.$route.query.id,
                        sectionId: this.sectionsList[nextIndex].sectionId
                    }
                    this.$router.push({ path: `${this.pages.detail.course.path}/test`, query: query })
                } else {
        ...
        .video-box {
            ...
            .bottom {
                ...
                .icon-report-error {
                    ...
                    margin-right: 6px;
                    background: url("~@/assets/img/course/icon_error.png") no-repeat;
                }
                .btn-has-learned {
                    position: absolute;
                    right: 0;
            ...
            .btn-folder {
                ...
                background: url("~@/assets/img/course/btn_folder.png") no-repeat;
                &:hover {
                    opacity: .75;
                }
            }
